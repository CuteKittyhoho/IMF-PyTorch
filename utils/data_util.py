...
def write_img_vec(datasets):
    ...
    with open(path + 'entity2id.txt', 'r', encoding='utf-8') as f:
        with h5py.File(path + datasets + '_ImageData.h5', 'r', encoding='utf-8') as img:
...
def load_data(datasets):
    ...
    img_features = pickle.load(open(path + 'patch_img.kpl', 'rb'))
    #print(img_features.size)
    #text_features = pickle.load(open(path+'text_features.pkl', 'rb'))
    text_features = pickle.load(open(path + 'ner_tensor.kpl', 'rb'))
